<%@ Page Title="" Language="C#" MasterPageFile="~/ClientMasterpage.master" AutoEventWireup="true" CodeFile="gps.aspx.cs" Inherits="gps" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="container">
            ...
            <h1><div align="center" id="value">
                ...
                <asp:HiddenField ID="DistanceValue" runat="server" />
            ...
            <script>
                ...
                function calc2() {
                    ...
                    document.getElementById('<%= DistanceValue.ClientID %>').value = value;
                ...
                function calc() {
                    ...
                    if (second == "30" || second == "10" || second == "50"|| second == "20"|| second == "40"|| second == "00") {
                        var array = [document.getElementById('<%= arrayValue.ClientID %>').value];

                        var hr = document.getElementById('<%= DistanceValue.ClientID %>').value;
                        ...
                        var x = array.push("[" + account_ID + "$"+ hr + "$"  + YYYY + "-" + MM + "-" + DD + "$" + hour + ":" + minute + ":" + second + "]");
