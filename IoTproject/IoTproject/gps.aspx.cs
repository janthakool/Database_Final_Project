        ...
        using (connectStore_linqDataContext db0 = new connectStore_linqDataContext())
        {
            ...
            foreach (string word1 in words1)
            {
                if (word1 != "" && word1 != null)
                {
                    ...
                    //insert words2[2] as date
                    //insert words2[3] as time
                    ...
                    db0.INSERT_velocityGPS(accountID, heartrateValue, dateValue, timeValue);
                    arrayValue.Value = "";
                }
            ...
            //db0.INSERT_heartrate(59361430, int.Parse(heartrateValue.Value), dtnew, TimeSpan.Parse(timeFormat));
